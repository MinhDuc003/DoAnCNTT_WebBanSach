...
<body style="background-color: #f0f1f2;">
	...
	<c:if test="${not empty failedMsg}">
		<div class="alert text-center alert-danger" role="alert">${failedMsg }</div>
				...
				<div class="card">
					<div class="card-body">
						...
						<input type="hidden" value="${userobj.id }" name="id">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Phone Number</label> <input
										type="number" name="phone" class="form-control" id="inputEmail4" value="${userobj.phone }" required>
								</div>
								<div class="form-group col-md-6">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Pin code</label> <input type="text" name="pincode"
										class="form-control" id="inputPassword4" required>
								</div>
								<div class="form-group col-md-6">
